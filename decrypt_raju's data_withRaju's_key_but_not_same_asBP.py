...
password = b'22222222222222222222222222222222'
cipher_DES3 = DES3.new(digest_key, DES3.MODE_CBC, IV=b'00000000')
enc_pass_enc = cipher_DES3.encrypt(password)

print(('enc_password is this ', enc_pass_enc))
digest_data = enc_pass_enc.digest()
print(digest_data)
...
test2 = de_cipher.decrypt(enc_pass_enc)
print(test2)
